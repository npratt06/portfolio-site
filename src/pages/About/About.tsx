    ...
    return (
      <div style={aboutStyle}>
        <div style={outerWrapper}>
          ...
          <div style={aboutRowStyle}>
            <div style={{ ...this.styleSet.aboutRowContentStyle, ...this.styleSet.aboutTxtWrapperStyle }}>{aboutContentOne}</div>
          ...
          <div style={aboutRowStyle}>
            ...
            <div style={{ ...this.styleSet.aboutRowContentStyle, ...this.styleSet.aboutTxtWrapperStyle }}>{aboutContentTwo}</div>
          </div>
          <div style={aboutRowStyle}>
            <hr style={this.styleSet.hrStyle}></hr>
          </div>
          <div style={aboutRowStyle}>
            <div style={{ ...this.styleSet.aboutRowContentStyle, ...this.styleSet.aboutTxtWrapperStyle }}>{aboutContentThree}</div>
            <div style={this.styleSet.aboutImgWrapperStyle}>
          ...
          <div style={aboutRowStyle}>
            ...
            <div style={{ ...this.styleSet.aboutRowContentStyle, ...this.styleSet.aboutTxtWrapperStyle }}>{aboutContentFour}</div>
          </div>
